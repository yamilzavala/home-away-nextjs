...
export const findExistingReview = async (propertyId: string, userId: string) => {
...
export const createBookingAction = async (prevState: { 
  ...
  // delete all bookings with false status
